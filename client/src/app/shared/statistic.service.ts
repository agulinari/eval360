...
export class StatisticService {
    ...
    public REPORTS_API = this.API + '/statistics';

    constructor(private http: HttpClient) {
    }

    get(idProject: string): StatisticSp {
        return this.loadStatisticsSps();
    }

    loadStatisticsSps(): StatisticSp {
        let statisticSp = new StatisticSp();
        statisticSp.name = 'Nombre proyecto';
